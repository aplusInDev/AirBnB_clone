...
class TestCityInstant(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        city_instancestr = city_instance.__str__()
        self.assertIn("[City] (123456)", city_instancestr)
        self.assertIn("'id': '123456'", city_instancestr)
        self.assertIn("'created_at': " + dt_repr, city_instancestr)
        self.assertIn("'updated_at': " + dt_repr, city_instancestr)
...
class TestCitySave(unittest.TestCase):
    """ "Test cases for City class save method."""
    ...
    def test_save_updates_file(self):
        city_instance = City()
        city_instance.save()
        city_instanceid = "City." + city_instance.id
        with open("file.json", "r") as f:
            self.assertIn(city_instanceid, f.read())


class TestCityToDict(unittest.TestCase):
    """Test cases for City class to_dict method."""
    ...
    def test_to_dict_datetime_attributes_are_strs(self):
        city_instance = City()
        city_instance_dict = city_instance.to_dict()
        self.assertEqual(str, type(city_instance_dict["id"]))
        self.assertEqual(str, type(city_instance_dict["created_at"]))
        self.assertEqual(str, type(city_instance_dict["updated_at"]))
